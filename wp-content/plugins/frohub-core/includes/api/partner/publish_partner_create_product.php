...
class PublishPartnerCreateProduct {
    ...
    public function register_rest_routes() {
        register_rest_route('/v1/partner/', 'publish-partner-create-product/', array(
            'methods'             => 'POST',
    ...
    public function publish_partner_create_product(WP_REST_Request $request) {
        ...
        return new WP_REST_Response(['success' => true, 'product_id' => $product_id, 'partner_post_id' => $partner_post_id], 200);
    }
}