...
class CancelOrderButton
{
    ...
    {
        $self = new self();
        add_shortcode('cancel_order_button', array($self, 'cancel_order_button_shortcode'));
    }
    ...
    public function cancel_order_button_shortcode()
    {
        ...
        $last_order = wc_get_customer_last_order($customer->ID, 'any');
        ...
        if ($order_status === 'on-hold' || $order_status === 'processing') {
            ...
            <div class="cancel_order_button" data-order-id="<?php echo esc_attr($order_id); ?>">
                <button class="modal-trigger w-btn us-btn-style_6 w-btn-underlined"
                    data-modal="<?php echo esc_attr($modal_id); ?>" data-order-id="<?php echo esc_attr($order_id); ?>">
                    Cancel Order
                </button>
            </div>
            ...
            <div id="earlyCancelModal_<?php echo esc_attr($order_id); ?>" class="status-modal">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>You're within the early cancellation window. If you proceed, your deposit will be refunded, but the
                            booking fee is non-refundable.</p>
                    </div>
                    <div class="modal-footer">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Since your appointment is within 7 days, this counts as a late cancellation. Your deposit and booking fee
                            won’t be refunded as per our cancellation policy.</p>
            ...
            <div id="cancelReasonModal_<?php echo esc_attr($order_id); ?>" class="status-modal cancel-reason-modal">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5>Help us improve, tell us why you’re cancelling</h5><span class="close-modal">×</span>
                    </div>
                    <div class="modal-body">
                        ...
                        <form id="cancel-reason-form-<?php echo esc_attr($order_id); ?>">
                            ...
                            <label><input type="radio" name="reason" value="no-response"> The stylist didn’t respond in
                                time</label><br>
                            <label><input type="radio" name="reason" value="stylist-cancel"> The stylist asked me to
                                cancel</label><br>
