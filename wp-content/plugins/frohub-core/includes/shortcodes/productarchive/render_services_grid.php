...
class RenderServicesGrid {
    ...
    public function render_services_grid_shortcode() {
        ...
        ob_start();
        ?>
        <div class="render_services_grid" data-key="<?php echo esc_attr($unique_key); ?>"></div>
        
        <div class="custom-filters">
            <?php echo do_shortcode('[wbcr_php_snippet id="1688"]'); ?>
            <?php echo do_shortcode('[wbcr_php_snippet id="1690"]'); ?>
            <?php echo do_shortcode('[wbcr_php_snippet id="1693"]'); ?>
            <?php echo do_shortcode('[wbcr_php_snippet id="1695"]'); ?>
            <?php echo do_shortcode('[wbcr_php_snippet id="1709"]'); ?>
