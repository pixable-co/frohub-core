...
class FrohubReviewSummary {
    ...
    public function frohub_review_summary_shortcode() {
        ...
        <div class="frohub-review-summary">
          ...
          <div class="metrics">
            <div class="metric">
              ...
              <div class="meta-label">Reliability <strong><?php echo esc_html( $avg_reliability ); ?></strong></div>
            </div>
            <div class="metric">
              <div class="circle"></div>
              <div class="meta-label">Skill <strong><?php echo esc_html( $avg_skill ); ?></strong></div>
            </div>
            <div class="metric">
              <div class="circle"></div>
              <div class="meta-label">Professionalism <strong><?php echo esc_html( $avg_professionalism ); ?></strong></div>
            </div>
          </div>
        </div>
        ...
        .frohub-review-summary .metric .meta-label strong {
          color: #000;
          margin-left: .25rem;
        }
        </style>
