                        ...
                        item.addEventListener("click", () => {
                            ...
                            if (type === "parent") {
                                ...
                                const data = new URLSearchParams({
                                    ...
                                    partner_id: partnerId // ← send the current post/partner ID
                                });
...
<?php
    ...
    {
        if (! $partner_id) {
            // fallback if someone really didn’t pass it
            $partner_id = get_the_ID();
        }
        ...
        foreach ($children as $term) {
            // only show this term if the partner really has >=1 product in it
            $has_products = (new \WP_Query([
                'post_type'      => 'product',
                'fields'         => 'ids',
                'posts_per_page' => 1,
