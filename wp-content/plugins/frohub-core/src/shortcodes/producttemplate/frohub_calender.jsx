...
const FrohubCalender = () => {
    ...
    const [allBookedDays, setAllBookedDays] = useState([]);
        ...
        fetchData(
            ...
            (response) => {
                if (response.success) {
                    ...
                    setAllBookings(response.data.all_bookings || {});
                    setAllBookedDays(response.data.all_booked_days || []);
